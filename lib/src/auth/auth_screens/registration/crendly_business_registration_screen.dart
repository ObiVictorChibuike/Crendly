            ...
            children: [
              ...
              Align(
                ...
                child: Container(height: 80, width: 80,
                  ...
                  child: const Center(child: Icon(Icons.phone_android_rounded, color: kOrange, size: 20,)),
                ),
              ),
              Container(height: 55, width:3, color: kGreen,),
              const Spacer(),
              Text("Thank you for joining the \nCrendly business waitlist.", textAlign: TextAlign.center,
                style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kOrange, fontWeight: FontWeight.w700, fontSize: 20),),
              const Spacer(),
              Text("We will keep in touch and let you \nknow the latest development on \nCrendly Business.",textAlign: TextAlign.center,
  ...
  Widget build(BuildContext context) {
    return SafeArea(top: false, bottom: false,
      child: Scaffold(backgroundColor: kDarkBackGroundColor,
        appBar: CustomAppbar(
          title: Text("Crendly for business", style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontWeight: FontWeight.w700, fontSize: 24),),
            ...
            Expanded(
                child: Padding(
                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      const Spacer(),
                      Text("For businesses that want fair loans to power their ideas, we are designing a solution with you in mind.\n\n\n"
                          "Join the wait list to be the first to know when Crendly for Business is ready.", textAlign: TextAlign.start,
                          style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontWeight: FontWeight.w400, fontSize: 16)),
                      const Spacer(),
                      Align(alignment: Alignment.centerLeft,
                          child: Text("Business email address", style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontSize: 16, fontWeight: FontWeight.w500),)),
