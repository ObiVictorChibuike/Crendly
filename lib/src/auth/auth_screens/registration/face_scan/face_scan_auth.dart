            ...
            children: [
              Expanded(
                  child: SingleChildScrollView(
                    physics: const BouncingScrollPhysics(), primary: true,
                    child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const SizedBox(height: 75.0,),
                        Align(alignment: Alignment.center,
                            child: SvgPicture.asset(AssetPath.faceScan, height: 300, width: 300,)),
                        const SizedBox(height: 50,),
                        Align(alignment: Alignment.center,
                          child: Text("An Extra Authentication \nwith your face", textAlign: TextAlign.center,
                            style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontWeight: FontWeight.w700, fontSize: 20),),
                        ),
                        const SizedBox(height: 30,),
                        Align(alignment: Alignment.center,
                          child: Text("Scan your face to verify your identity", textAlign: TextAlign.center,
                            style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kOrange, fontSize: 14),),
                        ),
                        ...
                        Align(alignment: Alignment.center,
                          child: TextButton(onPressed: (){}, child: Text("Do this Later",
                            style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kGreen, decoration: TextDecoration.underline, fontSize: 16, fontWeight: FontWeight.w700),)),
                        )
                      ],
                    ),
                  )
