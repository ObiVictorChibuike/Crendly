...
class SelfEmployedOptionScreen extends StatefulWidget {
  ...
  @override
  _SelfEmployedOptionScreenState createState() => _SelfEmployedOptionScreenState();
}

class _SelfEmployedOptionScreenState extends State<SelfEmployedOptionScreen> {
  String? selectedIncomeRange;
  List<String> incomeRange = ["₦0 - ₦50,000", "₦50,000 - ₦200,000", "₦200,001 - ₦500,000", "₦500,001 - ₦1,000,000","₦1000,001 and above"];
  ...
  void showSalaryRangeBottomSheet(BuildContext context){
    ...
    List.generate(incomeRange.length, (index){
      return InkWell(
        onTap: (){
          setState(() {
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(incomeRange[index], style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontWeight: FontWeight.w400, fontSize: 16),),
                  selectedIncomeRange == incomeRange[index] ? const Icon(Icons.check, size: 12, color: kOrange,): const SizedBox()
                ],
              ),
    ...
    return SafeArea(top: false, bottom: false,
      child: Scaffold(backgroundColor: kDarkBackGroundColor,
        appBar: CustomAppbar(centerTitle: true,
          ...
          title: Text("Self Employed", style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontWeight: FontWeight.w700, fontSize: 24),),
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      ...
                      Align(alignment: Alignment.centerLeft,
                          child: Text("What is your Income range?",
                      ...
                      Container(height: 55, width: double.maxFinite,
                        ...
                        child: TextButton(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(selectedIncomeRange ?? "Income Range", style: TextStyle(color: selectedIncomeRange == null ? const Color(0xff868484) : kWhite, fontSize: 18),),
