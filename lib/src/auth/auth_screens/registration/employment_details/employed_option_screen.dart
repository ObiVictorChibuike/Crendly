...
class _EmployedOptionScreenState extends State<EmployedOptionScreen> {
  ...
  List<String> salaryRange = ["₦0 - ₦50,000", "₦50,000 - ₦200,000", "₦200,001 - ₦500,000", "₦500,001 - ₦1,000,000","₦1000,001 and above"];
  String? selectedEmploymentType;
  List<String> employmentType = ["Full-Time", "Contract",];
  ...
  void showSalaryRangeBottomSheet(BuildContext context){
    ...
    List.generate(salaryRange.length, (index){
      return InkWell(
        onTap: (){
          setState(() {
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(salaryRange[index], style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontWeight: FontWeight.w400, fontSize: 16),),
                  selectedSalaryRange == salaryRange[index] ? const Icon(Icons.check, size: 12, color: kOrange,): const SizedBox()
                ],
              ),
  ...
  void showEmploymentTypeBottomSheet(BuildContext context){
    MyBottomSheet().showDismissibleBottomSheet(context: context, height: MediaQuery.of(context).size.height/4.5, children:
    List.generate(employmentType.length, (index){
      return InkWell(
        onTap: (){
          setState(() {
        ...
        child: Padding(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(employmentType[index], style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontWeight: FontWeight.w400, fontSize: 16),),
                  selectedEmploymentType == employmentType[index] ? const Icon(Icons.check, size: 12, color: kOrange,): const SizedBox()
                ],
              ),
              const Divider(color: kLighterBackGroundColor,),
            ],
    ...
    return SafeArea(top: false, bottom: false,
      child: Scaffold(backgroundColor: kDarkBackGroundColor,
        appBar: CustomAppbar(centerTitle: true,
          ...
          title: Text("Employed", style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontWeight: FontWeight.w700, fontSize: 24),),
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start,
            children: [
              Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      Text("What is your employer’s name?", style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontSize: 16, fontWeight: FontWeight.w500),),
                      const SizedBox(height: 10,),
                      FormFieldWidget(
                        hintText: "Company name",
                      ),
                      const SizedBox(height: 25,),
                      Text("What is your Occupation?", style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontSize: 16, fontWeight: FontWeight.w500),),
                      const SizedBox(height: 10,),
                      FormFieldWidget(
                        hintText: "Your occupation",
                      ),
                      const SizedBox(height: 25,),
                      Text("What is your position at your company?", style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontSize: 16, fontWeight: FontWeight.w500),),
                      const SizedBox(height: 10,),
                      FormFieldWidget(
                      ...
                      Align(alignment: Alignment.centerLeft,
                          child: Text("What is your type of employment?",
                      ...
                      Container(height: 55, width: double.maxFinite,
                        ...
                        child: TextButton(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(selectedEmploymentType ?? "Employment type", style: TextStyle(color: selectedEmploymentType == null ? const Color(0xff868484) : kWhite, fontSize: 18),),
                      ...
                      const SizedBox(height: 25,),
                      Align(alignment: Alignment.centerLeft,
                          child: Text("What is your Salary range?",
                            style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontSize: 16, fontWeight: FontWeight.w500),)),
                      const SizedBox(height: 10,),
                      Container(height: 55, width: double.maxFinite,
                        decoration: BoxDecoration(border: Border.all(color: kWhite, width: 0.7), borderRadius: BorderRadius.circular(15)),
                        child: TextButton(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(selectedSalaryRange ?? "Salary Range", style: TextStyle(color: selectedSalaryRange == null ? const Color(0xff868484) : kWhite, fontSize: 18),),
                              const Icon(Icons.keyboard_arrow_down, color: kWhite)
                            ],
                          ),
                        ),
                      ...
                      GroupButton(
                        options: GroupButtonOptions(
                            ...
                            unselectedColor: Colors.transparent, mainGroupAlignment: MainGroupAlignment.start, selectedBorderColor: Color(0xff2E4DBD),
                            unselectedBorderColor: Color(0xff2E4DBD), crossGroupAlignment: CrossGroupAlignment.start,
