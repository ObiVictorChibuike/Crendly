    ...
    return SafeArea(top: false, bottom: false,
      child: Scaffold(backgroundColor: kDarkBackGroundColor,
        appBar: CustomAppbar(
          ...
          title: Text("Your Email Address", style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontWeight: FontWeight.w700, fontSize: 24),),
          ...
          child: Column(
            ...
            children: [
              Align(alignment: Alignment.centerLeft,
                  child: Text("Email address", style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontSize: 16, fontWeight: FontWeight.w500),)),
              ...
              Row(mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  ...
                  Expanded(
                      child: Text("Please provide a valid email address",
