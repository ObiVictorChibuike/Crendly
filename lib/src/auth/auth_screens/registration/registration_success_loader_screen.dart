...
class RegistrationSuccessLoaderScreen extends StatefulWidget {
  ...
  @override
  _RegistrationSuccessLoaderScreenState createState() => _RegistrationSuccessLoaderScreenState();
}
          ...
          children: [
            ...
            Align(
              ...
              child: Container(height: 80, width: 80,
                ...
                child: const Center(child: Icon(Icons.phone_android_rounded, color: kOrange, size: 35,)),
              ),
            ),
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center,
            children: [
              ...
              Align(alignment: Alignment.topCenter,
                  child: Text("This would take a second.", style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontSize: 16, fontWeight: FontWeight.bold),)),
              const SizedBox(height: 20,),
              SizedBox(height: 60, width: 60,
                child: CircularProgressIndicator.adaptive(
                  strokeWidth: 15.0, backgroundColor: kOrange,
                ),
              ),
              const Spacer()
            ],
