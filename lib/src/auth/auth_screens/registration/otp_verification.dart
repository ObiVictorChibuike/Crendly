  ...
  Widget build(BuildContext context) {
    return SafeArea(top: false, bottom: false,
      child: Scaffold(backgroundColor: kDarkBackGroundColor,
        appBar: CustomAppbar(
          flexibleSpace: const Padding(padding: EdgeInsets.only(top: 35.0, bottom: 10), child: LinearProgressIndicator(color: kGreen, value: 0.4,),),
          title: Text("OTP Verification", style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontWeight: FontWeight.w700, fontSize: 24),),
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              RichText(textAlign: TextAlign.center, text: TextSpan(text: "Enter verification code sent to your phone number ",
                  style: TextStyle(color: kWhite, fontWeight: FontWeight.w700, fontSize: 16,),
                  children: [
                    TextSpan(text: "081374484848.", style: Theme.of(context).textTheme.bodyText2?.copyWith(fontSize: 16, fontWeight: FontWeight.w700, color: kOrange)),
                  ]
              )),
              ...
              Align(alignment: Alignment.center,
                child: RichText(textAlign: TextAlign.center, text: TextSpan(text: "Code will resend in ",
                    style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontWeight: FontWeight.w400, fontSize: 14,),
                    children: [
                      TextSpan(text: "00:20", style: Theme.of(context).textTheme.bodyText2?.copyWith(fontSize: 14, fontWeight: FontWeight.w400, color: kOrange)),
                    ]
                )),
              ),
                  ...
                  Expanded(
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Text("Resend Code",
                            style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kGreen, fontSize: 14, fontWeight: FontWeight.w700, decoration: TextDecoration.underline),),
                        ],
                      )
                  ),
                ],
