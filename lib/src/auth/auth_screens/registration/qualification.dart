...
class _QualificationScreenState extends State<QualificationScreen> {
  ...
  List<String> qualification = [
    "Primary Education", "Secondary Education", "Bachelor’s Degree",
    "Bachelors + Professional Qualification","Masters Degree/PHD", "Vocational Training","None"
  ];
  ...
  void showGenderBottomSheet(BuildContext context){
    ...
    List.generate(qualification.length, (index){
      return InkWell(
        onTap: (){
          setState(() {
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(qualification[index], style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontWeight: FontWeight.w400, fontSize: 16),),
                  selectedQualification == qualification[index] ? const Icon(Icons.check, size: 12, color: kOrange,): const SizedBox()
                ],
              ),
    ...
    return SafeArea(top: false, bottom: false,
      child: Scaffold(backgroundColor: kDarkBackGroundColor,
        appBar: CustomAppbar(
          ...
          title: Text("Educational Background", style: Theme.of(context).textTheme.bodyText2?.copyWith(color: kWhite, fontWeight: FontWeight.w700, fontSize: 24),),
          ...
          child: Column(
            ...
            children: [
              Align(alignment: Alignment.centerLeft,
                  child: Text("What is your highest educational qualification?",
