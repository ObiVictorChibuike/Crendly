              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    ...
                    Text(currentIndex == 0 ? 'My Loans' : "My Portfolio",
                      style: Theme.of(context).textTheme.headline2!.copyWith(color: kWhite, fontSize: 24, fontWeight: FontWeight.bold),),
                    const Spacer()
                  ],
                ),
              ),
              Positioned(left: 93, top: 100, right: 93,
                child: Container(
