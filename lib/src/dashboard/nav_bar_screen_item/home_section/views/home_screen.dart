                ...
                return InkWell(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(
                        bottom: 10, top: 15, left: 24, right: 24),
                    child: Column(
                      children: [
                        Row(
                                                    ...
                                                    children: [
                                                      Align(
                                                        alignment:
                                                            Alignment.center,
                                                        child: Text(
                                                          "Make payment using this bank details.",
                                                          style: Theme.of(
                                                                  context)
                                                              .textTheme
                                                              .displaySmall
            ...
            Padding(
              ...
              child: ButtonWidget(
                onPressed: () {
                  setState(() {
                    Get.back();
                    userData.add({"amount": "N 20,000", "name": "Obi Victor"});
                  });
                },
                buttonText: "Go to Home",
                height: 50,
      ...
      Expanded(
        child: Column(
          ...
          children: [
            ...
            Text("Create your very own transaction PIN ",
                textAlign: TextAlign.center,
                style: Theme.of(context).textTheme.bodyText2?.copyWith(
                    color: kWhite, fontSize: 14, fontWeight: FontWeight.w400)),
            const Spacer(
              flex: 2,
            ),
            Text(
    ...
    MyBottomSheet().showNonDismissibleBottomSheet(
        ...
        children: [
          ...
          Align(
            alignment: Alignment.center,
            child: Text(
                "Fusce lacinia vulputate gravida massa \nnibh faucibus lorem vel etiam. ",
                textAlign: TextAlign.center,
                style: Theme.of(context).textTheme.bodyText2?.copyWith(
                          ...
                          child: Column(
                            ...
                            children: [
                              CircleAvatar(
                                  ...
                                  radius: 16,
                                  child: Icon(
                                    quickMenu[index]["image"],
                                    size: 20,
                                    color: kWhite,
                                  )),
                              Text(
                                quickMenu[index]["title"],
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyText2
                                    ?.copyWith(
          ...
          body: Column(
            children: [
              Container(
                ...
                width: double.maxFinite,
                height: userData.isEmpty
                    ? MediaQuery.of(context).size.height / 2.5
                    : MediaQuery.of(context).size.height / 2.2,
                decoration: BoxDecoration(
                    color: kLightBackGroundColor,
                    border: Border.all(color: kLightBackGroundColor),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: userData.isEmpty ? 20 : 25,
                    ),
                    Center(
                      child: Text(
                        userData.isEmpty ? "₦0" : '₦350,000.00',
                        style: Theme.of(context).textTheme.bodyText2?.copyWith(
                            color: kWhite,
                            ...
                            child: Column(
                              ...
                              children: [
                                CircleAvatar(
                                    backgroundColor: kBlue,
                                    radius: 28,
                                    child: rowButtonItem[index]["icon"]),
                                const SizedBox(
                                  height: 8,
                                ),
                                Text(
                                  rowButtonItem[index]["Text"],
                                  textAlign: TextAlign.center,
                                  style: Theme.of(context)
                                      .textTheme
                                      .bodyText2
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          padding: const EdgeInsets.only(
                              top: 23, left: 16, right: 16, bottom: 23),
                          width: double.maxFinite,
                          height: userData.isEmpty
                              ? MediaQuery.of(context).size.height / 4
