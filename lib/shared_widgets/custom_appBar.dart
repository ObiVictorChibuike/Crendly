...
class CustomAppbar extends StatelessWidget implements PreferredSizeWidget {
  ...
  const CustomAppbar(
      ...
      this.centerTitle,
        ...
        this.leadingWidget, this.appBarLabel, this.actionWidget,})
      : super(key: key);
      ...
      child: Column(
        children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              IconButton(onPressed: onBackPressed, icon: Icon(Icons.arrow_back_ios, size: 20, color: backButtonColor ?? kWhite,)),
