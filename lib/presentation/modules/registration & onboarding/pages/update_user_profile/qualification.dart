...
class _QualificationScreenState extends State<QualificationScreen> {
  ...
  void updatePersonalInfo(BuildContext context, RegistrationController controller)async{
    if(formKey.currentState!.validate()){
      formKey.currentState!.save();
      ShowProgressDialog().show;
      await controller.updateInfo();
      if(controller.updatePersonalInfoViewState.state == ResponseState.COMPLETE){
        ShowProgressDialog().hide;
        Get.offAll(() => EmploymentStatusOptions());
      }else if(controller.updatePersonalInfoViewState.state == ResponseState.ERROR){
        ShowProgressDialog().hide;
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropList(valueName: controller.educationalQualificationController,
                    iterable: qualification, hintText: 'Qualification',
                  ),
                  const Spacer(),
                  ButtonWidget(
                      onPressed: () {
                        if(controller.educationalQualificationController.text.isEmpty){
