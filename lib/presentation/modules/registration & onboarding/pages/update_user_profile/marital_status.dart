                ...
                children: [
                  ...
                  GroupButton(
                    options: GroupButtonOptions(
                        ...
                        selectedBorderColor: kDarkPurple, selectedColor: kDarkPurple,
                  ...
                  GroupButton(
                    ...
                    onSelected: (String value, index, isSelected) {
                      if (value == "Yes, I do") {
                        setState(() {
                          controller.hasNoDependents = null;
                        });
                      } else {
                        setState(() {
                          controller.hasNoDependents = "None";
                          controller.hasDependents = null;
                        });
                      }
                    },
                  ...
                  SizedBox(
                    height: controller.hasNoDependents == null ? 20 : 176,
                  ),
                  controller.hasNoDependents == null ? Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        "Do you have dependents?",
                        style: Theme.of(context).textTheme.bodyText2?.copyWith(
                  ...
                  ButtonWidget(
                      onPressed: () {
                        if(controller.maritalStatus == null){
                          FlushBarHelper(context, "Please, select marital status").showErrorBar;
                        }else if(controller.hasNoDependents == null && controller.hasDependents == null){
                          FlushBarHelper(context, "Please, select dependent status").showErrorBar;
                        }else{
