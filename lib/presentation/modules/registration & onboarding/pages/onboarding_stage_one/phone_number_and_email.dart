...
class _PhoneNumberScreenState extends State<PhoneNumberScreen> with FormMixin{
  ...
  void saveOnBoardingStateOne(BuildContext context, RegistrationController controller)async{
                      ...
                      Expanded(
                        child: IntlPhoneField(
                          validator: (value){
                            ...
                            } else if (!GetUtils.isNumericOnly(value.completeNumber.trim()) ||
                                !GetUtils.isLengthEqualTo(value.completeNumber.trim(), 11)) {
                          ...
                          dropdownTextStyle: Theme.of(context).textTheme.bodyText2?.copyWith(color: const Color(0xff868484), fontSize: 16),
                          dropdownIcon: Icon(Icons.arrow_drop_down, color: kWhite, size: 18,),
                          decoration: InputDecoration(
                            alignLabelWithHint: true,
                            floatingLabelBehavior: FloatingLabelBehavior.never,
                            hintStyle: Theme.of(context).textTheme.bodyText2?.copyWith(color: const Color(0xff868484), fontSize: 16),
                            labelStyle: Theme.of(context).textTheme.bodyText2?.copyWith(color: const Color(0xff868484), fontSize: 16),
                          ...
                          onChanged: (phone) {
                            controller.phoneNumber = "${phone.countryCode}" + controller.phoneNumberController.text.removeLeadingZero();
