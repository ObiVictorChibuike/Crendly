...
import 'package:crendly/presentation/modules/registration%20&%20onboarding/pages/onboarding_stage_one/bvn_verifcation.dart';
          ...
          child: Column(
            ...
            children: [
              Align(alignment: Alignment.center,
                child: Text("We are about the credibility of our platform. \nHence, you will "
                    "be asked a series of questions to \nonboard Crendly. Please be "
                    "patient and get all \nyour details handy. ", textAlign: TextAlign.center,
                                    ...
                                    child: SingleChildScrollView(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          ConstrainedBox(
                                              constraints: BoxConstraints(maxWidth: MediaQuery.of(context).size.width /2, minHeight: 30),
                                          ...
                                          ConstrainedBox(
                                              constraints: BoxConstraints(maxWidth: MediaQuery.of(context).size.width / 2, minHeight: 50),
              ...
              Align(alignment: Alignment.center,
                child: Text("Either way, we’ll be having a good \ntime together.", textAlign: TextAlign.center,
