...
class AuthRepository {
  ...
  Future<Response?> onBoardingStateOne(
      ...
      _authServices.onBoardingStateOne(
          bvn: bvn,
  ...
  Future<Response?> getResidenceCategories() =>
      _authServices.getResidenceCategories();
  ...
  Future<Response?> updatePersonalInformation(
      ...
      _authServices.updatePersonalInformation(
          userId: userId,
          firstName: firstName,
          lastName: lastName,
          gender: gender,
  ...
  Future<Response?> verifyOtp(
      ...
      _authServices.verifyOtp(otp: otp, userName: userName);

  Future<Response?> updateEmploymentDetails(
          {required String userId,
          String? employer,
      ...
      _authServices.updateUserEmploymentDetails(
          userId: userId,
          employer: employer,
  ...
  Future<Response?> updateRegulatoryId(
          {required String userId,
          required int type,
          ...
          String? expiryDate,
          String? imagePath}) =>
      _authServices.updateUserRegulatoryId(
          userId: userId,
          type: type,
          idNumber: idNumber,
          imagePath: imagePath,
