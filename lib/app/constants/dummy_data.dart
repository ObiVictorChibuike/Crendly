import 'package:crendly/app/shared_widgets/shared_questionnaire_screens.dart';
...
class DummyData {
  ...
  static final signUpOptions = [
    {
      ...
      "title": "Individual",
      "description":
          "Lend to credible people and earn interest on your terms. ",
      "color": orangeGradient,
    },
    {
      "asset": "assets/svg_assets/melon_head.svg",
      "title": "Business",
      "description": "Borrow for what you need at an incredible speed.",
      "color": greenGradient
    },
  ];
  ...
  static final List<PopupMenuItem> OpenLoanRequestOption = [
    PopupMenuItem(child: Column(
      crossAxisAlignment: CrossAxisAlignment.center,
      children: [
        const SizedBox(height: 20,),
        Text("View all Loan Requests", style: TextStyle(color: kWhite, fontSize: 16)),
    ...
    PopupMenuItem(child: Column(
      ...
      children: [
        ...
        Text("Take similar new loan", style: TextStyle(color: kWhite, fontSize: 16)),
        Divider(color: kDivider,)
      ],
    ),),
    PopupMenuItem(child: Column(
      crossAxisAlignment: CrossAxisAlignment.center,
      children: [
        Text("Cancel loan request", style: TextStyle(color: kRedPink, fontSize: 16)),
        Divider(color: kDivider,)
      ],
    ),),
  ];
  ...
  static final List<Widget> onBoardingViews = [
    CarouselPage(
      ...
      secondText: '\nsocial lending',
      thirdText: 'A Platform where real people can \nlend money to real people',
    ),
    const CarouselPage(
        image: AssetPath.onBoardingImage2,
        firstText: 'We turn up ',
        secondText: 'safety',
        thirdText: 'You worked hard for your money so  \nour security and fraud algorithms \nkeeps it super safe for you'),
    const CarouselPage(
        image: AssetPath.onBoardingImage3,
        firstText: 'You\'re in ',
        secondText: 'control',
        thirdText: 'Decide the profit you want to earn from \nthe money you lend. Borrow the loan \nwith a rate that works best for you'),
  ];
